...
public class CubeModel {
    ...
    public CubeModel() {
    	/*Calcula las normales a los planos del cubo. Es una función ya definida
    	 * en el lenguaje. Interiormente tiene en cuenta el productor vectorial entre
    	 * los vectores.
    	 * Así que para un triángulo p1, p2, p3, si el vector U = p2 - p1 y el vector 
    	 * V = p3 - p1 a continuación de la normal N = UXV y pueden calcularse por:
			N x = U y V z - T z V y
			N y = T z V x - U x V z
			N z = U x V y - U y V x
    	 */
    ...
    public int createVerticesBuffer() {
    	/*crea un buffer del tamaño del numero de vertices que nos hemos
    	 * definido arriba del todo
    	 */
    ...
    public int createColorsBuffer() {
    	/*lo crea un buffer con la longuitud de los datos
    	 * introduce las coordenadas que tienes almacenadas en la varible color
    	 * creamos el buffer vbo y por tanto nos hatamos a el
    	 * y por ultimo llenamos el buffer vbo con los datos que almacenamos
    	 * en el colorBuffers
    	 */
